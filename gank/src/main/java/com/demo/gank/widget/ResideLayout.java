...
public class ResideLayout extends ViewGroup {
    ...
    public interface PanelSlideListener {
         ...
         * to be interactive. It may now obscure other views in the list_item.
         *
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != MeasureSpec.EXACTLY) {
            if (isInEditMode()) {
                // Don't crash the list_item editor. Consume all of the space if specified
            ...
            if (isInEditMode()) {
                // Don't crash the list_item editor. Pick a magic number from thin air instead.
                // TODO Better communication with tools of this bogus state.
                // It will crash on a real device.
    ...
    /**
     * Open the sliding pane if it is currently slideable. If first list_item
    ...
    /**
     * Close the sliding pane if it is currently slideable. If first list_item
     * has already completed this will animate.
     *
    ...
    /**
     * Check if the list_item is completely open. It can be open either because the slider
    ...
    /**
     * @return true if content in this list_item can be slid open and closed
    ...
    /**
     * Check if the content in this list_item cannot fully fit side by side and therefore
    ...
    private void onPanelDragged(int newLeft) {
        if (mSlideableView == null) {
            // This can happen if we're aborting motion during list_item because everything now fits.
            mSlideOffset = 0;
            return;
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        /**
         * True if this pane is the slideable pane in the list_item.
         */
        boolean slideable;
