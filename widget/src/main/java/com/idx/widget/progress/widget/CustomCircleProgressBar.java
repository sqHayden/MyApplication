package com.idx.widget.progress.widget;
...
import com.idx.widget.progress.util.DimenUtil;
...
public class CustomCircleProgressBar extends View {
    ...
    private float front_progress; //记录上次进度
    ...
    private void startAnim(float progress) {
        if(front_progress == 0){
            ...
            animator = ObjectAnimator.ofFloat(front_progress, progress);
        }
        //改变后赋新值
